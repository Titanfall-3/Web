                ...
                <div class="card mb-5" style="background: var(--default-contrast-color);">
                    <div class="card-body d-flex flex-column align-items-center">
                        ...
                        <form class="text-center" method="post">
                            ...
                            <div class="mb-3"><input class="form-control" type="password" name="invite" placeholder="Invite"></div>
                            <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit">Register</button></div>
                            <p class="text-muted" style="color: var(--text-color);">You have a account?</p>
                        </form>
                    </div>
                </div>
            </div>
